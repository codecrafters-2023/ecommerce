        ...
        <>
            ...
            <div className="privacy-container">
                <main className="privacy-content">
                    <h2 style={{ marginBottom: "20px", fontSize: "2.5rem", textAlign: "center" }}>Terms Of Services</h2>

                    <h3>OVERVIEW</h3>
                    <p>This website is operated by FarFoo. Throughout the site, the terms “we”, “us” and “our” refer to FarFoo. FarFoo offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                    ...
                    <p>We may, but have no obligation to, monitor, edit or remove content that we determine in our sole discretion are unlawful, offensive, threatening, libelous, defamatory , obscene or otherwise objectionable or violates any party's intellectual property or these Terms of Service.</p>
                    ...
                    <p>You agree to indemnify, defend and hold harmless FarFoo and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
                    ...
                    <p>Questions about the Terms of Service should be sent to us at <a href='mailto:kam@gurmaanitservices.com' style={{ textDecoration: "underline", fontWeight: "600" }}>kam@gurmaanitservices.com</a></p>
                    <p>FarFoo</p>
                    <p>Vill: Kahangarh</p>
                    <p>Gurmaan IT Services LLP, KAHANGARH SANGRUR PUNJAB IN 148026 </p>
                    <p>Mobile no. +919814207077  +918804997000 </p>
                    <p>LLPIN AAQ-4542</p>
                </main>
            </div>
            <Footer />
