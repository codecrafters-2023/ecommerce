...
const Shop = () => {
  ...
  const demoProducts = [
    {
      id: 1,
      name: 'FarFoo Turmeric Powder/Haldi Powder 1kg',
      description: 'FarFoo Turmeric Powder is a high-quality spice that offers',
      price: 359,
      originalPrice: 410,
      rating: 4.8,
      reviews: 234,
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAxw86axerrBSTImISFPBtZ0DYxK-MLZvawA&s',
      weight: '1Kg',
      // discount: 17,
